...
public class Blocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(AscensionShard.MOD_ID, Registries.BLOCK);
    public static final DeferredRegister<BlockEntityType<?>> BLOCKENTITY = DeferredRegister.create(AscensionShard.MOD_ID, Registries.BLOCK_ENTITY_TYPE);
